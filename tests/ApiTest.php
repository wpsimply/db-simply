...
{
    public function testReadOnlySessionsCannotChangeRows(): void
    {
        ...
        foreach ([['insert', ['values' => ['id' => '1']]], ['update', ['key' => ['id' => '1'], 'values' => ['id' => '2']]], ['delete', ['keys' => [['id' => '1']]]], ['table', ['tables' => ['t'], 'operation' => 'drop']]] as [$action, $body]) {
