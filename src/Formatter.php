...
/**
 * Recognises what a column value holds and renders a readable version of it.
 *
...
final class Formatter
{
    ...
    public function describe(string $bytes, bool $complete = true): array
    {
        ...
        // properties serializes their names with NUL bytes, and WordPress keeps
        // plenty of them in its options and meta tables.
     ...
     * {@see Serialized}, never by unserialize(): values come from the
     * database, and nothing in them is instantiated or trusted.
     */
